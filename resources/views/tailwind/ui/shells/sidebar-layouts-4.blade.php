...
<div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }"
    ...
    <div x-show="sidebarOpen" class="md:hidden">
        ...
        <div class="fixed inset-0 flex z-40">
            <div x-show="sidebarOpen" x-transition:enter-start="-translate-x-full"
                ...
                class="flex-1 flex flex-col max-w-xs w-full bg-gray-800 transform ease-in-out duration-300 ">
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden">
        ...
        <main class="flex-1 relative z-0 overflow-y-auto pt-2 pb-6 focus:outline-none md:py-6" tabindex="0" x-data
            x-init="$el.focus()">
